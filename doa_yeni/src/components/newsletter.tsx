    ...
    <section>
      <div className="mx-auto mt-20 max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          {/* CTA box */}
          <div className="relative overflow-hidden rounded bg-gray-900 px-8 py-10 shadow-2xl md:px-12 md:py-16">
            ...
            <div className="relative flex flex-col items-center justify-between lg:flex-row">
              ...
              <div className="text-center lg:max-w-xl lg:text-left">
                ...
                Would you like to be the first to know about the latest updates?

                </h3>
                <p className="mb-6 text-lg text-gray-300">
                  
Subscribe to our newsletter to stay updated on the latest developments in our app!
                </p>
